"""
Django settings for skedlease project.
...
SECRET_KEY = 'django-insecure-5shc!x%(@m@@8s95jqxiohtr9uk*-^hl9eefn-3a3+^uy&1y#@'
...
WSGI_APPLICATION = 'skedlease.wsgi.application'
